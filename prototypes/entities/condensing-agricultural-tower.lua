...
data.extend({
{
    ...
    localised_name = {"entity-name.condensing-agricultural-tower"},
    localised_description = {"entity-description.condensing-agricultural-tower"},
...
},
{
    ...
    factoriopedia_description = {{"factoriopedia-description.condensing-agricultural-tower"},},
    minable = {mining_time = 0.2, result = "condensing-agricultural-tower"},
    fast_replaceable_group = nil,
    max_health = 300,
    corpse = "condensing-agricultural-tower-remnants",
    ...
    crane = require("__condensing-agricultural-tower__.prototypes.entities.condensing-agricultural-tower-crane"),
    ...
    graphics_set =
    {
      animation =
      {
        layers =
        {
          util.sprite_load("__condensing-agricultural-tower__/graphics/entity/condensing-agricultural-tower/condensing-agricultural-tower-base",
          {
            priority = "high",
          ...
          util.sprite_load("__condensing-agricultural-tower__/graphics/entity/condensing-agricultural-tower/condensing-agricultural-tower-base-shadow",
          {
            priority = "high",
            frame_count = 1,
            repeat_count = 64,
      ...
      {
        {
          ...
          animation = util.sprite_load("__condensing-agricultural-tower__/graphics/entity/condensing-agricultural-tower/condensing-agricultural-tower-base",
          {
            frame_count = 1,
            scale = 0.5
          }),
...

        {
          ...
          animation = util.sprite_load("__condensing-agricultural-tower__/graphics/entity/condensing-agricultural-tower/condensing-agricultural-tower-base-plant-mask",
          {
            priority = "high",
            frame_count = 64,
            animation_speed = 0.25,
        ...
        },
        {
          ...
          effect = "flicker",
          fadeout = true,
          animation = util.sprite_load("__condensing-agricultural-tower__/graphics/entity/condensing-agricultural-tower/condensing-agricultural-tower-base-light",
          {
            priority = "high",
            frame_count = 64,
            animation_speed = 0.25,
      ...
      water_reflection =
      {
        pictures =
        {
          filename = "__condensing-agricultural-tower__/graphics/entity/condensing-agricultural-tower/condensing-agricultural-tower-base-reflection.png",
          priority = "extra-high",
          width = 24,
          height = 36,
...
data.extend({
    {
        ...
        localised_name = {"entity-name.condensing-agricultural-tower"},
        localised_description = {"entity-description.condensing-agricultural-tower"},
        icon = "__condensing-agricultural-tower__/graphics/technology/condensing-agriculture.png",
        icon_size = 256,
        essential = true,
        effects = {
        {
...
local desc_parts = {
    "",
    {"factoriopedia-description.condensing-agricultural-tower"}
}
if settings.startup["enable-tree-condensing-water"].value == true then
    table.insert(desc_parts, {"factoriopedia-description.condensing-tree"})
end

if settings.startup["enable-jellynut-condensing-lubricant"].value == true then
    table.insert(desc_parts, {"factoriopedia-description.condensing-jellynut"})
end

if settings.startup["enable-yumako-condensing-steam"].value == true then
    table.insert(desc_parts, {"factoriopedia-description.condensing-yumako"})
end

data.raw["agricultural-tower"]["condensing-agricultural-tower"].factoriopedia_description = desc_parts